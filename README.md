...
```
bash <(curl -s https://raw.githubusercontent.com/NOTHURAIRAXD55/CRASHCLOUD-VPS-MAKER-BOT/main/install.sh)
```
OR

```
bash <(wget -qO- https://raw.githubusercontent.com/NOTHURAIRAXD55/CRASHCLOUD-VPS-MAKER-BOT/main/install.sh)
```
